...
public class ClubTotalPost extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_club_total_post, container, false);

        budae = getArguments().getString("budae");

        RecyclerView recyclerView = (RecyclerView) view.findViewById(R.id.club_total_post_recyclerview);
    ...
    private class DetailRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
        ...
        DetailRecyclerViewAdapter() {
            ...
            firestore.collection(budae+"동아리게시판").orderBy("timestamp", Query.Direction.DESCENDING)
        ...
        public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, final int position) {
            ...
            firestore.collection(budae+"동아리").document(contentDTOs.get(position).uid).get()
