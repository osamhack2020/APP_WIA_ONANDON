                    ...
                    .addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                        ...
                        public void onSuccess(DocumentSnapshot documentSnapshot) {
                            if(!documentSnapshot.exists()){
                                firestore.collection(user.getUid()+"_Activity_Scrap").document(contentUidList.get(position)).delete();
                            }
                            else{
                                final ActivityDTO activityDTO = documentSnapshot.toObject(ActivityDTO.class);

                                if(!activityDTO.scrap.containsKey(user.getUid())){
                                    firestore.collection(user.getUid()+"_Activity_Scrap").document(contentUidList.get(position)).delete();
                                }
                                else{
                                                ...
                                                public Void apply(@NonNull Transaction transaction) throws FirebaseFirestoreException {
                                                    ...
                                                    if(activityDTO == null){
                                                        ...
                                                        firestore.collection(user.getUid()+"_Activity_Scrap")
                                                                .whereEqualTo("timestamp", activityDTO.timestamp)
