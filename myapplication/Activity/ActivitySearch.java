...
public class ActivitySearch extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        firestore.collection("Activity_tag").document("tag").get()
                .addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                    ...
                    public void onSuccess(DocumentSnapshot documentSnapshot) {
                        ...
                        if(documentSnapshot.exists()) {
                            ...
                            ArrayAdapter<String> adapter = new ArrayAdapter<String>(ActivitySearch.this, android.R.layout.simple_expandable_list_item_1, dataList);
    ...
    class SearchListener implements SearchView.OnQueryTextListener{
        ...
        public boolean onQueryTextSubmit(String query) {
            ...
            FragmentManager manager = getSupportFragmentManager();
            FragmentTransaction tran = manager.beginTransaction();
            tran.replace(R.id.search_content, activityList);
            tran.commit();
