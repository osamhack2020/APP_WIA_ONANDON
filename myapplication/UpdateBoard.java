...
public class UpdateBoard extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        firestore.collection(budae+"게시판").document(documentUid).get()
            ...
            public void onClick(View view) {
                if(name.getText().toString().isEmpty() || name.getText().toString().isEmpty()){
                    Toast.makeText(UpdateBoard.this, "항목을 모두 작성해 주세요.", Toast.LENGTH_SHORT).show();
                        ...
                        firestore.collection(budae+"게시판").document(documentUid).update("name", name.getText().toString());
                        firestore.collection(budae+"게시판").document(documentUid).update("explain", explain.getText().toString());
