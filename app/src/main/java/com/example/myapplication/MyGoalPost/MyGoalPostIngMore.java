            ...
            case R.id.update :
                ...
                firestore.runTransaction(new Transaction.Function<Void>() {
                    ...
                    public Void apply(@NonNull Transaction transaction) throws FirebaseFirestoreException {
                        ...
                        Intent updateIntent = new Intent(MyGoalPostIngMore.this, UpdateGoal.class);
                        updateIntent.putExtra("documentUid", "MyGoal");
                        updateIntent.putExtra("postUid", intentDocument);
                        if (myGoalContentDTO.isPhoto == 1) {
                            updateIntent.putExtra("imageUri", myGoalContentDTO.imageUri);
                        }
