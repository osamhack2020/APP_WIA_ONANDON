...
public class DashboardFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        clubNewPost = (TextView)view.findViewById(R.id.club_new_post1);
        activityNewPost.setVisibility(View.GONE);
        marketNewPost.setVisibility(View.GONE);
        clubNewPost.setVisibility(View.GONE);

        myGoal = (RelativeLayout)view.findViewById(R.id.my_goal);
        myGoal.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getContext(), UserPostList.class);
                intent.putExtra("name", "나의 도전 이야기");
                intent.putExtra("documentUid", "MyGoal");
        ...
        clubLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(clubNewPost.getVisibility() == View.VISIBLE){
                    clubNewPost.setVisibility(View.GONE);
                }
            }
        });
                        ...
                        firestore.collection(userDTO.budae+"동아리게시판").orderBy("timestamp", Query.Direction.DESCENDING)
                            ...
                            public void onEvent(@Nullable QuerySnapshot value, @Nullable FirebaseFirestoreException error) {
                                ...
                                for(QueryDocumentSnapshot doc : value) {
                                    ...
                                    if(postDTO.timestamp > sharedPreferences.getLong("Club", 0)){
                                        clubNewPost.setVisibility(View.VISIBLE);
                                    }else{
                                        clubNewPost.setVisibility(View.GONE);
                                    }
