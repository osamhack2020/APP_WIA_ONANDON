...
public class MyPostGoal extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_my_post_goal, container, false);

        noPost = (TextView)view.findViewById(R.id.no_post);

        RecyclerView recyclerView = (RecyclerView) view.findViewById(R.id.my_goal_recyclerview);
    ...
    public class DetailRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
        ...
        DetailRecyclerViewAdapter() {
            ...
            firestore.collection("MyGoal").whereEqualTo("uid", user.getUid())
